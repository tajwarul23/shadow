...
function Navbar() {
  ...
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1">
      <li><Link className='text-white underline-none btn bg-neutral-700 focus:outline-none'to="/home">Home</Link></li>

      <li className='px-3'><Link className='text-white underline-none btn bg-neutral-700' to='/service'>Service</Link></li>
      <li><Link className='text-white underline-none btn bg-neutral-700' to="/about">About</Link></li>
